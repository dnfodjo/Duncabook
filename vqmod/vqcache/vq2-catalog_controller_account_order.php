	...
	public function info() {
		...
		if ($order_info) {
			...
			foreach ($products as $product) {
                ...
                $suborder_status = $suborder['order_status_id'] ? $suborder['order_status_id'] : $order_info['order_status_id'];
                foreach ($data['order_statuses'] as $order_status) {
                    if ($order_status['order_status_id'] == $suborder_status) $suborder_status_text = $suborder['order_status_id'] ? $order_status['name'] : "<i>${order_status['name']}</i>";
                }
