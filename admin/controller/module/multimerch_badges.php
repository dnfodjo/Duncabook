...
class ControllerModuleMultiMerchBadges extends ControllerMultisellerBase {
	private $name = 'multimerch_badges';
	...
	private function editSettings() {
		...
		$set = $this->model_setting_setting->getSetting("msconf_badge");
		...
		$this->model_setting_setting->editSetting("msconf_badge", $set);
	}
	
	public function install() {
		$this->load->model("module/{$this->name}");
		$this->model_module_multimerch_badges->createSchema();
	...
	public function uninstall() {
		$this->load->model("module/{$this->name}");
		$this->model_module_multimerch_badges->deleteSchema();
	}
