<?php
class ControllerModuleMultiMerchTopsellers extends ControllerMultisellerBase {
	private $version = '2.0';
	private $name = 'multimerch_topsellers';
	private $error = array();
	...
	public function index() {
		...
		$this->document->setTitle($this->language->get('ms_config_topsellers'));
