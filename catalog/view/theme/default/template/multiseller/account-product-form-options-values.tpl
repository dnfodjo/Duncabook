		...
		<div class="option_values mmCtr">
			<div class="option_value ffSample">
				...
				<span class="option_price">
					...
					<input type="text" class="form-control inline" placeholder="<?php echo $ms_options_price; ?>" name="product_option[<?php echo $option_index; ?>][product_option_value][0][price]" value="" size="5"></td>
			...
			<?php foreach ($product_option_values as $value) {?>
				<div class="option_value">
					...
					<span class="option_price">
						<?php echo $this->currency->getSymbolLeft(); ?>
						<input type="text" class="form-control inline" placeholder="<?php echo $ms_options_price; ?>" name="product_option[<?php echo $option_index; ?>][product_option_value][<?php echo $i; ?>][price]" value="<?php echo $this->MsLoader->MsHelper->trueCurrencyFormat($value['price']); ?>" size="5"></td>
						<?php echo $this->currency->getSymbolRight(); ?>
					</span>
