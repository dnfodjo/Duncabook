...
$_['ms_create_product'] = 'Sell Your Book';
$_['ms_delete'] = 'Delete';
$_['ms_update'] = 'Update';
$_['ms_type'] = 'Type';
$_['ms_amount'] = 'Amount';
...
$_['ms_totals_line'] = 'Curnently %s sellers and %s Books for sale!';
...
You can now start adding your Books.
Click the Link below to Create a Free PayPal Account if You dont have one.
...
$_['ms_mail_subject_product_awaiting_moderation'] = 'Book awaiting moderation';
$_['ms_mail_product_awaiting_moderation'] = <<<EOT
Your Book %s at %s is awaiting moderation.
...
Your Book(s) have been purchased from %s.

Please ship Book and mark order as shipped with tracking number to recieve payment.
...
$_['ms_mail_subject_remind_listing'] = 'Book listing has finished';
$_['ms_mail_seller_remind_listing'] = <<<EOT
Your Book's %s listing has finished. Go to your account seller area if you would like to re-list the Book.
EOT;
...
$_['ms_mail_admin_subject_product_created'] = 'New Book added';
$_['ms_mail_admin_product_created'] = <<<EOT
New Book %s has been added to %s.

You can view or edit it in back office.
EOT;

$_['ms_mail_admin_subject_new_product_awaiting_moderation'] = 'New Book awaiting moderation';
$_['ms_mail_admin_new_product_awaiting_moderation'] = <<<EOT
New Book %s has been added to %s and is awaiting moderation.

You can process it in the Multiseller - Books section in back office.
EOT;

$_['ms_mail_admin_subject_edit_product_awaiting_moderation'] = 'Book edited and awaiting moderation';
$_['ms_mail_admin_edit_product_awaiting_moderation'] = <<<EOT
Book %s at %s has been edited and is awaiting moderation.
...
// Success
$_['ms_success_product_published'] = 'Book published';
$_['ms_success_product_unpublished'] = 'Book unpublished';
$_['ms_success_product_created'] = 'Book created';
$_['ms_success_product_updated'] = 'Book updated';
$_['ms_success_product_deleted'] = 'Book deleted';
...
$_['ms_error_product_name_empty'] = 'Book name cannot be empty';
$_['ms_error_product_name_length'] = 'Book name should be between %s and %s characters';
$_['ms_error_product_description_empty'] = 'Book description cannot be empty';
$_['ms_error_product_description_length'] = 'Book description should be between %s and %s characters';
$_['ms_error_product_tags_length'] = 'Line too long';
$_['ms_error_product_price_empty'] = 'Please specify a price for your Book';
...
$_['ms_error_product_model_empty'] = 'Book model cannot be empty';
$_['ms_error_product_model_length'] = 'Book model should be between %s and %s characters';
$_['ms_error_product_image_count'] = 'Please upload at least %s image(s) for your Book';
$_['ms_error_product_download_count'] = 'Please submit at least %s download(s) for your Book';
...
$_['ms_error_seller_product'] = 'You can\'t add your own Book to cart';
...
$_['ms_account_register_seller'] = 'Register Account';
$_['ms_account_register_seller_note'] = 'Create a seller account and start selling your Books in our store!';
...
$_['ms_account_register_seller_success_message']  = '<p>Welcome to %s!</p> <p>Congratulations! Your new seller account has been successfully created!</p> <p>You can now take advantage of seller privileges and start selling your Books with us.</p> <p>If you have any problems, <a href="%s">contact us</a>.</p>';
...
$_['ms_account_seller_account'] = 'My Account';
...
$_['ms_account_newproduct'] = 'Sell Your Book';
$_['ms_account_products'] = 'Books';
...
// Account - New Book
$_['ms_account_newproduct_heading'] = 'Sell Your Book';
$_['ms_account_newproduct_breadcrumbs'] = 'Sell Your Book';
//General Tab
...
$_['ms_account_product_name_note'] = 'Specify a name for your Book';
$_['ms_account_product_description'] = 'Description';
$_['ms_account_product_description_note'] = 'Describe your Book';
$_['ms_account_product_meta_description'] = 'Meta Tag Description';
$_['ms_account_product_meta_description_note'] = 'Specify Meta Tag Description for your Book';
$_['ms_account_product_meta_keyword'] = 'Meta Tag Keywords';
$_['ms_account_product_meta_keyword_note'] = 'Specify Meta Tag Keywords for your Book';
$_['ms_account_product_tags'] = 'Tags';
$_['ms_account_product_tags_note'] = 'Specify tags for your Book.';
$_['ms_account_product_price_attributes'] = 'Price & Attributes';
$_['ms_account_product_price'] = 'Price';
$_['ms_account_product_price_note'] = 'Choose a price for your Book';
$_['ms_account_product_listing_flat'] = 'Listing fee for this Book is <span>%s</span>';
$_['ms_account_product_listing_percent'] = 'Listing fee for this Book is based on the Book price. Current listing fee: <span>%s</span>.';
$_['ms_account_product_listing_balance'] = 'This amount will be deducted from your seller balance.';
$_['ms_account_product_listing_paypal'] = 'You will be redirected to the PayPal payment page after Book submission.';
$_['ms_account_product_listing_itemname'] = 'Book listing fee at %s';
$_['ms_account_product_listing_until'] = 'This Book will be listed until %s';
$_['ms_account_product_category'] = 'Category';
$_['ms_account_product_category_note'] = 'Select category for your Book';
$_['ms_account_product_enable_shipping'] = 'Enable shipping';
$_['ms_account_product_enable_shipping_note'] = 'Specify whether your Book requires shipping';
$_['ms_account_product_quantity'] = 'Quantity';
$_['ms_account_product_quantity_note']    = 'Specify the quantity of your Book';
$_['ms_account_product_files'] = 'Files';
$_['ms_account_product_download'] = 'Downloads';
$_['ms_account_product_download_note'] = 'Upload files for your Book. Allowed extensions: %s';
...
$_['ms_account_product_image_note'] = 'Select images for your Book. First image will be used as a thumbnail. You can change the order of the images by dragging them. Allowed extensions: %s';
...
$_['ms_account_product_jan'] = 'AUTHOR';
$_['ms_account_product_jan_note'] = 'Author of the Book';
$_['ms_account_product_isbn'] = 'ISBN';
$_['ms_account_product_isbn_note'] = 'This is the 13 digit number located at the back of the book near the barcode(EX: 9780133962031‎)';
...
$_['ms_account_product_stock_status_note'] = 'Status shown when a book is out of stock';
...
$_['ms_account_editproduct_heading'] = 'Edit Book';
$_['ms_account_editproduct_breadcrumbs'] = 'Edit Book';

// Account - Clone product
$_['ms_account_cloneproduct_heading'] = 'Clone Book';
$_['ms_account_cloneproduct_breadcrumbs'] = 'Clone Book';

// Account - Relist product
$_['ms_account_relist_product_heading'] = 'Relist Book';
$_['ms_account_relist_product_breadcrumbs'] = 'Relist Book';
...
$_['ms_account_sellerinfo_paypal_note'] = '';
...
// Account - Products
$_['ms_account_products_heading'] = 'Your Books';
$_['ms_account_products_breadcrumbs'] = 'Your Books';
$_['ms_account_products_image'] = 'Image';
$_['ms_account_products_product'] = 'Book';
...
$_['ms_account_products_noproducts'] = 'You don\'t have any Books yet!';
$_['ms_account_products_confirmdelete'] = 'Are you sure you want to delete your Book?';
...
$_['ms_conversation_title_product'] = 'Inquiry about Book: %s';
...
$_['ms_account_orders_products'] = 'Books';
$_['ms_account_orders_history'] = 'Shipping Information     (ADD Tracking Number / Change Status Dropdown to shipped / SUMBIT)';
...
$_['ms_account_orders_add_comment']    = 'Add TRACKING NUMBER and Comments here';
$_['ms_account_orders_add_history']    = 'Sumbit';
...
$_['ms_account_dashboard_nav_product'] = 'Sell Your Book';
$_['ms_account_dashboard_nav_products'] = 'Manage your Books';
...
$_['ms_account_stats_tab_by_product'] = 'By Book';
...
$_['ms_account_stats_product'] = 'Book';
...
$_['ms_catalog_sellers_totalproducts'] = 'Books:';
...
$_['ms_catalog_seller_profile_products'] = 'Some of seller\'s Books';
$_['ms_catalog_seller_profile_tab_products'] = 'Books';
...
$_['ms_catalog_seller_profile_totalproducts'] = 'Total Books:';
$_['ms_catalog_seller_profile_view_products'] = 'View Books';
$_['ms_catalog_seller_profile_view'] = 'View all %s\'s Books';

// Catalog - Seller's products list
$_['ms_catalog_seller_products_heading'] = '%s\'s Books';
$_['ms_catalog_seller_products_breadcrumbs'] = '%s\'s Books';
$_['ms_catalog_seller_products_empty'] = 'This seller doesn\'t have any Books yet!';
