...
class ControllerModuleMultiMerchNewsellers extends ControllerSellerCatalog {
	public function index($setting) {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/multimerch_newsellers.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/module/multimerch_newsellers.tpl', $this->data);
		} else {
